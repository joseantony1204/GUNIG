 ...
 */
class Radicadosinternos1 extends CActiveRecord
{
	/**
	 ...
	 */
	public $ENVIA, $DESTINOINTERNO, $DESTINOEXTERNO, $RECIBIDO, $ARCHIVO;
	...
	public function rules()
	{
		...
		return array(
			...
			//array('RAIN_GUIAENVIO', 'length', 'max'=>45),
			array('RAIN_TIPO', 'length', 'max'=>20),
			array('RAIN_UBICACION', 'length', 'max'=>20),
			array('ARCHIVO', 'file', 'types'=>'pdf'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ARCHIVO, RAIN_ID, RAIN_FECHA, RAIN_ASUNTO, RAIN_ESCANEORUTA, RAIN_NUMEROANEXOS, RAIN_ESTADO, RAIN_TIPO, RAIN_UBICACION', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		//$criteria->compare('RAIN_GUIAENVIO',$this->RAIN_GUIAENVIO);
