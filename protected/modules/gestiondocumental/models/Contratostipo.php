 ...
 */
class Contratostipo extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Contratostipo the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('TICO_NOMBRE,TICO_ID', 'required'),
	...
	{
		return array(
			'TICO_ID' => 'TIPO DE CONTRATOS',
			'TICO_NOMBRE' => 'CONTRATOS',
			'TICO_DESCRIPCION' => 'DESCRIPCION',
		);
	}
