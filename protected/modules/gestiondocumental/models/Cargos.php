 ...
 * @property TBLPERSNATUDEPENDENCIAS[] $tBLPERSNATUDEPENDENCIASes
 */
class Cargos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('CARG_NOMBRE', 'length', 'max'=>100),
	...
	public function relations()
	{
		...
		return array(
			'tBLPERSNATUDEPENDENCIASes' => array(self::HAS_MANY, 'Persnatudependencias', 'CARG_ID'),
		);
	}
