...
/*
$this->menu=array(
	array('label'=>'List Recibidos','url'=>array('index')),
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('recibidos-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('recibidos/admin',),$htmlOptions ); 
?>         
		 </td>
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('recibidos/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
