      ...
      <tr>
        <td width="60" align="left"><?php 			 
			 $imageUrl = Yii::app()->request->baseUrl . '/images/user.png';
			  ...
			  ?></td>
        <td align="left">
        <strong style="border-bottom-style:groove">PROCESO DE CREACIÒN DE REGISTROS [ENTES EXTERNOS: Nuevo] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('rcdarchivo/entesexternos/creates','id'=>$model->RAEX_ID),$htmlOptions); 
?>         
		          </td>
      </tr>
    </table></td>
