      ...
      <tr>
        <td width="60" align="left"><?php 			 
			 $imageUrl = Yii::app()->request->baseUrl . '/images/user.png';
			  ...
			  ?></td>
        <td align="left">
        <strong style="border-bottom-style:groove">PROCESO DE CREACIÒN DE REGISTROS [REMITENTES: Nuevo] </strong></td>
        <td width="80" align="center">
         ...
         echo CHtml::link($image, array('rcdarchivo/entesexternos/creates1','id'=>$model->RAEX_ID),$htmlOptions ); 
?>  
		 </td>
        <td width="80" align="center">
