      ...
      <tr>
        <td width="60" align="left"><?php 			 
			 $imageUrl = Yii::app()->request->baseUrl . '/images/user.png';
			  ...
			  ?></td>
        <td align="left">
        <strong style="border-bottom-style:groove">PROCESO DE ACTUALIZACIÒN DE REGISTROS [REMITENTES: Editar] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('rcdarchivo/enexraex/update','id'=>$model->EERE_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
