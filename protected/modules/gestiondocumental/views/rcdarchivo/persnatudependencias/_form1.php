...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<strong style="border-bottom-style:groove"><?php echo $model->rel_personasnaturales->PENA_NOMBRES . " ". $model->rel_personasnaturales->PENA_APELLIDOS; ?> </strong>
	<br><br>
	<?php 
	...
	<?php echo $form->dropDownList($model,'DEPE_ID', CHtml::listData(Dependencias::model()->findAll(array('order'=>'DEPE_NOMBRE')), 'DEPE_ID','DEPE_NOMBRE'), array('empty'=>' '));?>
