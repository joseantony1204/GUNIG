        ...
        <fieldset>
          <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE CARGOS</em></span></strong></td>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
    ...
    'filter'=>$model,
	'columns'=>array(
		//array('name'=>'CARG_ID', 'value'=>'$data->CARG_ID','htmlOptions'=>array('width'=>'10'),),
		array('name'=>'CARG_NOMBRE', 'value'=>'$data->CARG_NOMBRE','htmlOptions'=>array('width'=>'300'),),
