...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<strong style="border-bottom-style:groove"><?php echo $model->RAEX_ID; ?> </strong>
	<br><br>
	
	<?php echo DESTINATARIO,": ";?><br>
	<strong style="border-bottom-style:groove"><?php echo $model->rel_persnatudependencias->rel_personasnaturales->PENA_NOMBRES  . " ". $model->rel_persnatudependencias->rel_personasnaturales->PENA_APELLIDOS  . " (". $model->rel_persnatudependencias->dEPE->DEPE_NOMBRE  . ") "; ?> </strong>
	<br><br>
