...
div.loading {
    ...
    background-image: url('/GUNIG/images/ajax-loader.gif');
...
<?php $this->widget('bootstrap.widgets.TbButton', array(
  'label'=>$model->isNewRecord ? 'CREAR REGISTRO Y CARGAR DOCUMENTO' : 'Actualizar',
  'buttonType'=>'ajaxButton',
  'icon'=>'ok white', 
  'url'=>$this->createUrl('mdlexpediente/expedientedocumentos/request/id/984'),
  'type'=>'success',
  'size'=>'small',
  'ajaxOptions'=>array(
      'type' => 'POST',
