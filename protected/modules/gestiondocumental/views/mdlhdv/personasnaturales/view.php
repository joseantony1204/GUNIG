...
<table width="50%" border="0" align="left">
  ...
  <tr>
    <td height="21"><fieldset>
	 ...
	 echo CHtml::link($image, array('mdlhdv/hdvexpedientedocumentos/admin','id'=>$model->PERS_ID),$htmlOptions ); 
	?></td>
	...
	?></td>
	 ...
	 $htmlOptions = array('class' => 'thumbnail','rel' => 'tooltip','data-title' => 'Educacion Continuada');
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlhdv/hdveducacioncontinua/admin','id'=>$model->PENA_ID),$htmlOptions ); 
	?></td>
        </tr>
        <tr>
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlhdv/personasexperiencialaboral/admin','id'=>$model->PERS_ID),$htmlOptions ); 
	?></td>
          <td>&nbsp;</td>
          <td align="center"><?php /*
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlhdv/personasnaturales/update','id'=>$model->PENA_ID),$htmlOptions ); 
	*/?>
            <?php
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlhdv/personasnaturales/miscontratos','id'=>$model->PENA_ID,),$htmlOptions ); 
	?></td>
          <td align="center">&nbsp;</td>
          <td align="center">
	<?php 
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlhdv/personasnaturales/view','id'=>$model->PENA_ID),$htmlOptions ); 
	?></td>
        </tr>
        <tr>
