...
<td width="9%" align="center">
         ...
         echo CHtml::link($image, array('mdlhdv/personasnaturales/miscontratos','id'=>$Personasnaturales->PENA_ID),$htmlOptions ); 
        ?>         
...
<td width="9%" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlhdv/expedientedocumentos/unirpdf','id'=>$model->CONT_ID),$htmlOptions ); 
?></td>
