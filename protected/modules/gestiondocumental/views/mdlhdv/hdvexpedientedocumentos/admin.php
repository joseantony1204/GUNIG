    ...
    <td><table width="100%" border="0" align="center">
      <tr>
        ...
        <fieldset>
         ...
         echo CHtml::link($image, array('mdlhdv/personasnaturales/view','id'=>$Personasnaturales->PENA_ID,),$htmlOptions ); 
?></td>
...
<td width="9%" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlhdv/hdvexpedientedocumentos/unirpdf','id'=>$model->PERS_ID,),$htmlOptions ); 
?></td>
...
<td width="9%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlhdv/hdvexpedientedocumentos/create','id'=>$model->PERS_ID),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
