...
/*
$this->menu=array(
	array('label'=>'List Hdvtiposdocumentos','url'=>array('index')),
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('hdvtiposdocumentos-grid', {
		data: $(this).serialize()
	});
	return false;
});
        ...
        <fieldset>
          <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE TIPOS DOCUMENTOS</em></span></strong></td>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	'id'=>'hdvtiposdocumentos-grid',
	'dataProvider'=>$model->search(),
	'type'=>'striped bordered condensed',
    'filter'=>$model,
	'columns'=>array(
		array('name'=>'HTDO_ID', 'value'=>'$data->HTDO_ID', 'htmlOptions'=>array('width'=>'10'),),
		array('name'=>'HTDO_NOMBRE', 'value'=>'$data->HTDO_NOMBRE', 'htmlOptions'=>array('width'=>'300'),),
