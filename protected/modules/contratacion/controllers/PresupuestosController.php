...
class PresupuestosController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Presupuestos']))
		{
			...
			$certificado = $model->attributes['PRES_NUM_CERTIFICADO'];
			$fecha = $model->attributes['PRES_FECHA_VIGENCIA'];
			$seccion = $model->attributes['PRES_SECCION'];
			$codigo = $model->attributes['PRES_CODIGO'];
			$formatoFechas->fechaLarga($fecha);
			$nombre = "No. ".$certificado.", del ".$formatoFechas->fecha." Seccion ".$seccion." codigo ".$codigo;
	        $model->PRES_NOMBRE = $nombre;
			if($model->save()){
