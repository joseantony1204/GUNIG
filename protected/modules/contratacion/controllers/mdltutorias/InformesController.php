...
class InformesController extends Controller
{
		...
		if(!Yii::app()->user->getIsGuest())
        {
         ...
         return array(
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				  ...
				  ''.$array[6].'',''.$array[7].'',''.$array[8].'',''.$array[9].'','estudios'),
    ...
    public function actionDependencias()
	{
	  ...
	  if((isset($_POST['Informes'])))
	  {
	   $Informes->attributes=$_POST['Informes'];	   
	   $Informes->CONT_NUMORDEN = $Informes->attributes=$_POST['Informes']["CONT_NUMORDEN"];
	   $programas = $Tutoriascontratos->reporteProgramas($Informes);
	...
	public function actionGeneral()
	{
	  ...
	  if((isset($_POST['Informes'])))
	  {
	   $Informes->attributes=$_POST['Informes'];	   
	   $Informes->CONT_NUMORDEN = $Informes->attributes=$_POST['Informes']["CONT_NUMORDEN"];
	   $registros = $Tutoriascontratos->reporteGeneral($Informes);
	...
	public function actionEstudios()
	{
	  ...
	  if((isset($_POST['Informes'])))
	  {
	   $Informes->attributes=$_POST['Informes'];	   
	   $Informes->CONT_NUMORDEN = $Informes->attributes=$_POST['Informes']["CONT_NUMORDEN"];
	   $registros = $Tutoriascontratos->reporteEstudios($Informes);
	   $this->render('rep_estudios',array(
		                                      'registros'=>$registros,		
		                                     ));  	  
	  }	  
