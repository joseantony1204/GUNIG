...
class AdicionalespresupuestosController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		$Adicionalespresupuestos = new Adicionalespresupuestos;
		...
		if(isset($_POST['Presupuestos']))
		{
			...
			if($Presupuestos->save()){
				...
				$Adicionalespresupuestos->PRES_ID = $lastData->PRES_ID;
				$Adicionalespresupuestos->ADPR_FECHA_INGRESO = $lastData->PRES_FECHA_INGRESO; 
				if($Adicionalespresupuestos->save()){
		...
		$this->render('create',array('model'=>$Presupuestos,'Adicionalespresupuestos'=>$Adicionalespresupuestos));
	}
	...
	{	
		$Adicionalespresupuestos = new Adicionalespresupuestos;
		$Adicionalespresupuestos = $this->loadModel($id);
		$Presupuestos = Presupuestos::model()->findByPk($Adicionalespresupuestos->PRES_ID);
		...
		$this->render('update',array(
			'model'=>$Presupuestos,
			'Adicionalespresupuestos'=>$Adicionalespresupuestos,
		));
	}
	...
	{
		$dataProvider=new CActiveDataProvider('Adicionalespresupuestos');
	...
	{
		$model=new Adicionalespresupuestos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Adicionalespresupuestos']))
			$model->attributes=$_GET['Adicionalespresupuestos'];
	...
	{
		$model=Adicionalespresupuestos::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='Adicionalespresupuestos-form')
		{
