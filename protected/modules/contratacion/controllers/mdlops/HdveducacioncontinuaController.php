...
class HdveducacioncontinuaController extends Controller
{
	/**
	...
	{
		$model=new Hdveducacioncontinua;
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Hdveducacioncontinua']))
		{
			$model->attributes=$_POST['Hdveducacioncontinua'];
			if($model->save())
				$this->redirect(array('admin','id'=>$model->HECO_ID));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Hdveducacioncontinua');
	...
	{
		$model=new Hdveducacioncontinua('search');
		$criteria = new CDbCriteria;
        $criteria->condition = 'PERS_ID = '.$id;		
        $Personanatural = Personasnaturales::model()->find($criteria);		
        $Personasnaturales = Personasnaturales::model()->findByPk($Personanatural->PENA_ID);
		...
		if(isset($_GET['Hdveducacioncontinua'])){
			$model->attributes=$_GET['Hdveducacioncontinua'];
		}
	...
	{
		$model=Hdveducacioncontinua::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hdveducacioncontinua-form')
		{
