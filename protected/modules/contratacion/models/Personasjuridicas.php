...
class Personasjuridicas extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'rel_personas_naturales' => array(self::HAS_ONE, 'Personasnaturales', 'PENA_ID'),
			'rel_representante' => array(self::HAS_ONE, 'Representante', 'PEJU_ID'),
