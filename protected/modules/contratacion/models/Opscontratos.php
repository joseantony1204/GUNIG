...
class Opscontratos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('OPCO_ID, OPCO_VALOR_MENSUAL, OPCO_MESES, OPCO_DIAS, OPOB_ID, OPPR_ID, DEPE_ID, ANAC_ID, CONT_ID,
			CONT_NUMORDEN, PERS_ID, PERS_IDENTIFICACION, CONT_FECHAINICIO, CONT_FECHAFINAL', 'safe', 'on'=>'searchSupervisores'),
		);
	}
	...
	public function search()
	{
		...
		$array = new CActiveDataProvider($this, array(
			'criteria'=>$criteria,
			'sort'=>$sort,
			'pagination' => array('pageSize' => 15,),
		));
		Yii::app()->user->setState('OpscontratosSearchParams', $array);
		return $array;
	}
