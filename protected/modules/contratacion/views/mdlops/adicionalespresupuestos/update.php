...
$this->breadcrumbs=array(
	...
	'Presupuestos Adicionales'=>array('admin'),
	'Actualizar',
);
?>
  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		PRESUPUESTOS ADICIONALES  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlops/adicionalespresupuestos/update','id'=>$Adicionalespresupuestos->ADPR_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
