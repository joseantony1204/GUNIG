...
$this->breadcrumbs=array(
	'Contratosadicionales'=>array('index'),
	'Crear',
);
?>
  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		CONTRATOSADICIONALES  : Editar ] </strong></td>
        <td width="80" align="center">
         ...
         echo CHtml::link($image, array('contratosadicionales/admin',),$htmlOptions ); 
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('contratosadicionales/update','id'=>$model->COAD_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
