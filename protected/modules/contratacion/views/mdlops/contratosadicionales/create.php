  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		ADICIONALES DE CONTRATOS   : Nuevo ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlops/contratosadicionales/create',),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_form', array('Contratosadicionales'=>$Contratosadicionales,'Contratos'=>$Contratos)); ?></p></td>
  </tr>
</table>
