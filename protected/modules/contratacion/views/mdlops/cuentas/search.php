  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td align="left">
        <strong style="border-bottom-style:groove">BUSQUEDA DE CUENTAS LIQUIDADAS [ 
		CUENTAS  : Buscar ] </strong></td>
...
?>         
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_formu', array('model'=>$model)); ?></p></td>
  </tr>
</table>
