...
$this->breadcrumbs=array(
	...
	'Seguimiento Cuenta'=>array('mdlops/seguimientocuentas/admin','id'=>$Seguimientocuentas->CUEN_ID),
...
<td width="7%" align="center"><?php
         ...
         echo CHtml::link($image, array('mdlops/seguimientocuentas/admin','id'=>$Seguimientocuentas->CUEN_ID),$htmlOptions ); 
?></td>
...
<td width="7%" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlops/devolucionescuentas/admin','id'=>$model->SECU_ID),$htmlOptions ); 
?></td>
            </tr>
          </table>
          </fieldset>
