...
$this->breadcrumbs=array(
	...
	'Supervisión de Contratos'=>array('/contratacion/mdlops/opscontratos/adminSupervisores',),
	'Administrar',
);
...
<td width="9%" align="center"><?php
         ...
         echo CHtml::link($image, array('/contratacion/mdlops/opscontratos/adminSupervisores',),$htmlOptions ); 
?></td>
<td width="9%" align="center"><?php         
	   $imageUrl = Yii::app()->request->baseUrl . '/images/refrescar.png';
       $htmlOptions = array('class' => 'thumbnail','rel' => 'tooltip','data-title' => 'Refrescar Pagina');
       $image = CHtml::image($imageUrl);
       echo CHtml::link($image, array('mdlops/expedientedocumentos/adminSupervisor','id'=>$model->CONT_ID),$htmlOptions ); 
  ?></td>
...
<td width="9%" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlops/expedientedocumentos/create2','id'=>$model->CONT_ID),$htmlOptions ); 
?></td>
            </tr>
          </table>
          </fieldset>
