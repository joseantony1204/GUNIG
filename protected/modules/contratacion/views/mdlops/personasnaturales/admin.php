...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlops/personasnaturales/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		...
		array(
               ...
               'buttons'=>array(  
                'delete' => array(
			    'url'=>'Yii::app()->controller->createUrl("mdlops/personas/delete", array("id"=>$data[PERS_ID],"command"=>"delete"))',
				),
