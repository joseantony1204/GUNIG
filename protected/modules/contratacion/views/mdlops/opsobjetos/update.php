...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlops/opsobjetos/update','id'=>$Opsobjetos->OPOB_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
  ...
  <tr>
   <td><p><?php echo $this->renderPartial('_form', array('Objetos'=>$Objetos, 'Opsobjetos'=>$Opsobjetos)); ?></p></td>
  </tr>
</table>
