...
<td width="7%" align="center">
         ...
         echo CHtml::link($image, array('/contratacion/Contratacioncpanel/index',),$htmlOptions ); 
?>         
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlordenes/contratantes/admin',),$htmlOptions ); 
?>         
		 </td>
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlordenes/contratantes/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
