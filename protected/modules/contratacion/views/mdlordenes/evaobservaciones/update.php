  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td align="left">
        <strong style="border-bottom-style:groove">PROCESO DE ACTUALIZACIÒN DE REGISTROS [OBSERVACIONES  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlordenes/evaobservaciones/update','id'=>$model->EVOB_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
