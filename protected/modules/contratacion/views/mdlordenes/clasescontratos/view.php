...
?>         
        ...
        <td width="80" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('clasescontratos/view','id'=>$model->CLCO_ID),$htmlOptions ); 
?>         
		 </td>
        <td width="80" align="center"><?php
         ...
         $htmlOptions = array('class' => 'thumbnail','rel' => 'tooltip','data-title' => 'Creaciòn de registros');
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('clasescontratos/update','id'=>$model->CLCO_ID),$htmlOptions ); 
?>         
		 </td>
      </tr>
    </table></td>
