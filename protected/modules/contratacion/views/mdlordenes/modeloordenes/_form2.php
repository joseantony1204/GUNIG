...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<table width="100%" border="0">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;</td>
	    <td width="116" colspan="2"><div align="left">
     ...
     'changeYear' => 'true',
	  ...
	  <tr>
	    ...
	    <td>&nbsp;</td>
	    <td colspan="5"><?php echo $form->hiddenField($Presupuestos,'PRES_FECHA_INGRESO',array('value'=>date("Y-m-d").' '.date("h:i:s"),));?><?php echo $form->hiddenField($Presupuestosordenes,'PRES_ID',array('class'=>'span2')); ?>
