...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<table width="100%" border="0">
	  <tr>
	    <td colspan="8"><h5>GENERALIDADES DE LA ORDEN</h5></td>
	  ...
	  <tr>
            ...
            <?php 
                ...
                echo $form->dropDownList($Contratos,'CLCO_ID',$lista_uno,
                        array(
						      'ajax' => array(
                                              'type' => 'POST',
                                              'url' => CController::createUrl('mdlordenes/modeloordenes/formclcontrato'),
		...
		?>
          <?php echo $form->error($Contratos,'CLCO_ID'); ?></div></td>
	    </tr>
	  <tr>
	  ...
	  <?php //echo $form->error($Contratos,'PERS_ID'); ?>    
        ...
        <?php echo $form->hiddenField($Contratos,'CONT_FECHAPROCESO',array('value'=>date("Y-m-d").' '.date("h:i:s"),));?>
        
         <?php echo $form->hiddenField($Contratos,'PECO_ID');?>
        
	       <?php echo $form->labelEx($Contratos,'CONT_FECHAPROCESO'); ?>
           <?php 
     if ($Contratos->CONT_FECHAINICIO=='') {
     $Contratos->CONT_FECHAINICIO = date('Y-m-d');
     }else{
		 if ($Contratos->CONT_FECHAINICIO=='0000-00-00') {
		  $Contratos->CONT_FECHAINICIO = date("Y-m-d").' '.date("h:i:s") ;
		  }
		  }
     ...
     'buttonText'=>'Fecha de Elaboracion de Contrato',
     ...
     'changeYear' => 'true',
           ...
           <?php echo $form->error($Contratos,'CONT_FECHAINICIO'); ?>
</div></td>
	    </tr>
	  <tr>
	    <td width="36" colspan="3"><div align="left"><?php echo $form->textFieldRow($Modeloordenes,'MOOR_VALOR',array('class'=>'span4')); ?></div></td>
	    <td>&nbsp;</td>
	    <td width="116"><div align="left">
	      <h5>DURACIÓN</h5></div></td>
	  ...
	  <tr>
	   ...
	   $data = CHtml::listData(Contratantes::model()->findAll($criterio),'PECO_ID','rel_personas_naturales.nombreCompleto') ?>
	      <?php echo $form->dropDownList($Contratos,'PECO_ID',$data, array('class'=>'span4','prompt'=>'Elije...')); ?> <?php echo $form->error($Contratos,'PECO_ID');  */?>
     ...
     'changeYear' => 'true',
          ...
          <?php echo $form->error($Contratos,'CONT_FECHA_INICIO'); */?>
	        ...
	        <?php /*echo*/  $form->textFieldRow($Contratos,'CONT_FECHAFINAL',array('class'=>'span2')); ?>
          </div></td>
          
          
           <?php echo $form->hiddenField($Contratos,'CONT_ANIO',array('value'=>date("Y"),));?>	    </tr>
	  <tr>
	    <td colspan="3"><div align="left">
         
          <?php echo $form->labelEx($Formcontratosformatos,'FCCO_ID'); ?>
          <?php 
                $lista_uno = array();
            ...
            <?php //echo $form->error($Formcontratosformatos,'FCCO_ID'); ?>  
        ...
        <?php echo $form->hiddenField($Modeloordenes,'TIVI_ID',array('value'=>'5')); ?>
          <?php echo $form->error($Modeloordenes,'TIVI_ID'); ?> 
          
          </div></td>
	    </tr>
	  <tr>
	    <td colspan="8"><?php echo $form->textAreaRow($Modeloordenes,'MOOR_OBJETO',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>
        </td>
	    </tr>
	  <tr>
	    <td colspan="8">&nbsp;</td>
	  ...
	  <tr>
	    <td colspan="8"><h5>DISPONIBILIDAD PRESUPUESTAL</h5></td>
	    </tr>
	  <tr>
	    ...
	    <td colspan="4"><?php echo $form->textFieldRow($Presupuestos,'PRES_CODIGO',array('class'=>'span2')); ?></td>
	    </tr>
	  <tr>
     ...
     'changeYear' => 'true',
	  ...
	  <tr>
	    <td colspan="8"><h5>SUPERVISIÓN Y CONTROL</h5></td>
	    </tr>
	  <tr>
	    <td colspan="3"> 
	      <?php 
        ...
        ?> 
	      <?php echo $form->error($Supervisores,'CARG_ID'); ?></td>
	    </tr>
	  <tr>
	 
	    <td>&nbsp;</td>
	    <td colspan="4"><?php echo $form->hiddenField($Presupuestos,'PRES_FECHA_INGRESO',array('value'=>date("Y-m-d").' '.date("h:i:s"),));?><?php echo $form->hiddenField($Presupuestosordenes,'PRES_ID',array('class'=>'span2')); ?>
	      <?php //echo $form->textFieldRow($Presupuestos,'PRES_NOMBRE',array('class'=>'span2')); ?></td>
	    </tr>
	  </table>
	<p class="note">
