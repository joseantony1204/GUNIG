<?php
 ...
 // Información referente al PDF
  ...
  /* OBTENIENDO EL NOMBRE DEL CONTRATISTA */	
  ...
  if(($Formclasescontratos->FCCO_ID)==302){/*SI ES UNA ORDEN DE SUMINISTRO SIN POLIZA */
	  ...
	  ///***** CREANDO ARCHIVO *****///
	   ...
	   <tr>
		 <td align="center"><strong>'.$tipo.' '.$numero.' DE '.$clase.' DE  '.$anio_contrato.' </strong></td>
	   </tr>
	   <tr>
	    <td align="center">&nbsp;</td>
	   </tr>
	   <tr>
		...
		<tr>
		 ...
		 <strong>'.$valorContratoLetras.' ($'.number_format($valorContrato).') M/CTE.</strong> '.$Modeloordenes->rel_formadepago->FOPA_DESCRIPCION.'. 
		</td>
		</tr>
		...
		<tr>
		 <td align="justify"><strong><u>'.$nombreClausulas[3].' - '.$descripcionClausula[3].'</u>:</strong> 
		...
		<tr>
		 ...
		 '; 
			 ...
			 $descdp[] = $Cdp->PRES_NOMBRE;
				 ...
				 if ($numerocdp==1) { 
					$html .='	
					 <strong> '.$Modeloordenes->Presupuestoordenes->PRES_NOMBRE.'.</strong> 
					        ';
				 } elseif($numerocdp==2) { 
					 $html .='	
  ...
  elseif(($Formclasescontratos->FCCO_ID)==301){/*SI ES UNA ORDEN DE SUMINISTRO CON POLIZA */
   ...
   elseif(($Formclasescontratos->FCCO_ID)==4){/*SI ES UNA ORDEN DE PRESTACION DE SERVICIOS SIN POLIZA*/
	  ...
	  ///***** CREANDO ARCHIVO *****///
	   ...
	   <tr>
		 <td align="center"><strong>'.$tipo.' DE PRESTACIÓN DE SERVICIOS No. '.$numero.'  DE  '.$anio_contrato.' </strong></td>
	   </tr>
	   <tr>
		 <td align="center">&nbsp;</td>
	   </tr>
	   <tr>
		 ...
		 <table width="100%" border="1">
		  ...
		  <tr>
			...
			<td align="justify" width="80%"><strong>'.$Modeloordenes->rel_contrato->Persona->rel_personas_juridicas->PEJU_NOMBRE.''.
			 $Modeloordenes->rel_contrato->Persona->rel_personas_naturales->PENA_NOMBRES.' '.
			 $Modeloordenes->rel_contrato->Persona->rel_personas_naturales->PENA_APELLIDOS.'</strong></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			...
			<td align="justify" width="80%"><strong>'.$Modeloordenes->MOOR_OBJETO.'.</strong></td>
		  </tr>
		  <tr>
			<td align="left" width="20%">DURACIÓN:</td>
			<td align="justify" width="80%"><strong>'.$anioPlazo.' '.$mesesPlazo.' '.$diaPlazo.'.</strong></td>
		  </tr>
		</table>
	  ...
	  <tr>
	    ...
	    <tr>
		<td align="justify">Entre los suscritos a saber: 
		<strong>'.$Modeloordenes->rel_contrato->rel_contratantes->rel_personas_naturales->PENA_NOMBRES.' 
		'.$Modeloordenes->rel_contrato->rel_contratantes->rel_personas_naturales->PENA_APELLIDOS.'</strong>, 
		mayor de edad, identificado(a) con la cédula de ciudadanía No. 
		'.$Modeloordenes->rel_contrato->Persona->PERS_IDENTIFICACION.'
		Expedida en '.$Modeloordenes->rel_contrato->rel_contratantes->rel_personas_naturales->PENA_LUGAREXPIDENTIDAD.', 
		quien actúa en nombre y representación legal de LA UNIVERSIDAD DE LA GUAJIRA, identificada con el Nit. 892.115.029-4, 
		en su condición de '.$Modeloordenes->rel_contrato->rel_contratantes->PECO_DESCRIPCION.', 
		designado(a) mediante '.$Modeloordenes->rel_contrato->rel_contratantes->rel_resoluciones->REAC_DESCRIPCION.', 
		quien para los efectos del presente documento se denominará <strong>LA UNIVERSIDAD</strong>, por una parte y por la otra parte,
		 '; 
		 if ($datacontratista>0) {
		 //si es una persona natural
		 //echo "Entro al si";
		 $html.='
		 <strong>'.$Modeloordenes->rel_contrato->Persona->rel_personas_naturales->PENA_NOMBRES.' 
		 '.$Modeloordenes->rel_contrato->Persona->rel_personas_naturales->PENA_APELLIDOS.'
		 </strong>
		 mayor de edad, identificado(a) con la cédula de ciudadanía No. 
		 '.$Modeloordenes->rel_contrato->Persona->PERS_IDENTIFICACION.',
		 expedida en '.$Modeloordenes->rel_contrato->Persona->rel_personas_naturales->PENA_LUGAREXPIDENTIDAD.', 
		 quien actúa en nombre propio, con domicilio en '.$Modeloordenes->rel_contrato->Persona->rel_municipios->MUNI_NOMBRE.'
		 ('.$Modeloordenes->rel_contrato->Persona->rel_departamentos->DEPA_NOMBRE.'),
		 '; 
		 }  else{
		   //si es una persona juridica
		  // echo "Entro al sino";
		   $html.='
		   <strong>
		   '.$Modeloordenes->rel_contrato->Persona->rel_personas_juridicas->rel_representante->rel_personas_naturales->PENA_NOMBRES.' 
		   '.$Modeloordenes->rel_contrato->Persona->rel_personas_juridicas->rel_representante->rel_personas_naturales->PENA_APELLIDOS.'
		   </strong>
		   mayor de edad, identificado(a) con la cédula de ciudadanía No.
		  '.$Modeloordenes->rel_contrato->Persona->rel_personas_juridicas->rel_representante->rel_personas_naturales->rel_personas->PERS_IDENTIFICACION.'
		 expedida en '.$Modeloordenes->rel_contrato->Persona->rel_personas_juridicas->rel_representante->rel_personas_naturales->PENA_LUGAREXPIDENTIDAD.'
		   quien actúa en nombre y representación legal de la empresa 
		   <strong>'.$Modeloordenes->rel_contrato->Persona->rel_personas_juridicas->PEJU_NOMBRE.'</strong>, con domicilio en 
			'.$Modeloordenes->rel_contrato->Persona->rel_personas_juridicas->rel_personas->rel_municipios->MUNI_NOMBRE.'
			('.$Modeloordenes->rel_contrato->Persona->rel_personas_juridicas->rel_personas->rel_departamentos->DEPA_NOMBRE.'),
		   '; 
		   }
		 $html .='
		en adelante y para efectos del presente contrato se denominará <strong>EL CONTRATISTA</strong> y en consideración a: 
		...
		<strong>'.$descripcionClausula[10].'</strong> '.$partesDescripcionClausula[10][0].':
		 ...
		 '; 
		  ...
		  // echo "Entro al sino";
		   $html.='
		   <strong>'.$Modeloordenes->rel_contrato->Persona->rel_personas_juridicas->PEJU_NOMBRE.'</strong>, 
		   '; 
		   }
		 $html .='
		'.$partesDescripcionClausula[11][0].'.
		<strong> '.$descripcionClausula[11].'</strong> '.$partesDescripcionClausula[12][0].' 
		...
		<strong>'.$nombreClausulas[16].' - '.$descripcionClausula[16].'</strong>: '.$partesDescripcionClausula[15][0].' 
		<strong>'.$Modeloordenes->MOOR_OBJETO.'</strong>'.$partesDescripcionClausula[16][0].'.
		<strong>'.$nombreClausulas[17].' - '.$descripcionClausula[17].'</strong>: '.$partesDescripcionClausula[17][0].' '.$valorContratoLetras.' 
		($'.number_format($valorContrato).') M/CTE. 
		<strong>'.$nombreClausulas[18].' - '.$descripcionClausula[18].'</strong>: '.$partesDescripcionClausula[18][0].' 
		<strong> '.$Modeloordenes->rel_formadepago->FOPA_DESCRIPCION.'.</strong> '.$partesDescripcionClausula[19][0].'.
		<strong>'.$nombreClausulas[19].' - '.$descripcionClausula[19].'</strong>: '.$partesDescripcionClausula[20][0].'   
		<strong> '.$Modeloordenes->rel_presupuesto->Presupuestoordenes->PRES_NOMBRE.'.</strong> 
		<strong>'.$nombreClausulas[20].' - '.$descripcionClausula[20].'</strong>: '.$partesDescripcionClausula[21][0].' 
		<strong>'.$anioPlazo.' '.$mesesPlazo.' '.$diaPlazo.'</strong> '.$partesDescripcionClausula[22][0].'.
		<strong>'.$nombreClausulas[21].' - '.$descripcionClausula[21].'</strong>: '.$partesDescripcionClausula[23][0].'.
		<strong>'.$nombreClausulas[22].' - '.$descripcionClausula[22].'</strong>: '.$partesDescripcionClausula[24][0].'.
		<strong>'.$nombreClausulas[23].' - '.$descripcionClausula[23].'</strong>: '.$partesDescripcionClausula[25][0].'.
		<strong>'.$nombreClausulas[24].' - '.$descripcionClausula[24].'</strong>: '.$partesDescripcionClausula[26][0].'
		'; 
		     foreach($datagarantias as $rows){
			 $Garantias = Garantias::model()->findByPk($rows["GARA_ID"]);
			 $desgarantia[] = $Garantias->GARA_DESCRIPCION;
	...
	$html .='
	<strong>'.$nombreClausulas[25].' - '.$descripcionClausula[25].'</strong>: '.$partesDescripcionClausula[27][0].'.
	<strong>'.$nombreClausulas[26].' - '.$descripcionClausula[26].'</strong>: '.$partesDescripcionClausula[28][0].' <strong>'.$Modeloordenes->rel_contrato->Supervisor->Cargo->CARG_NOMBRE.' </strong>'.$partesDescripcionClausula[29][0].'.
		<strong>'.$nombreClausulas[27].' - '.$descripcionClausula[27].'</strong>: '.$partesDescripcionClausula[30][0].'.
		<strong>'.$nombreClausulas[28].' - '.$descripcionClausula[28].'</strong>: '.$partesDescripcionClausula[31][0].'.
		<strong>'.$nombreClausulas[29].' - '.$descripcionClausula[29].'</strong>: '.$partesDescripcionClausula[32][0].'.
		<strong>'.$nombreClausulas[30].' - '.$descripcionClausula[30].'</strong>: '.$partesDescripcionClausula[33][0].'.
		<strong>'.$nombreClausulas[31].' - '.$descripcionClausula[31].'</strong>: '.$partesDescripcionClausula[34][0].'.
		<strong>'.$nombreClausulas[32].' - '.$descripcionClausula[32].'</strong>: '.$partesDescripcionClausula[35][0].'.
		<strong>'.$nombreClausulas[33].' - '.$descripcionClausula[33].'</strong>: '.$partesDescripcionClausula[36][0].'.
		<strong>'.$nombreClausulas[34].' - '.$descripcionClausula[34].'</strong>: '.$partesDescripcionClausula[37][0].'.
		<strong>'.$nombreClausulas[35].' - '.$descripcionClausula[35].'</strong>: '.$partesDescripcionClausula[38][0].'.
		<strong>'.$nombreClausulas[36].' - '.$descripcionClausula[36].'</strong>: '.$partesDescripcionClausula[39][0].'.
		<strong>'.$nombreClausulas[37].' - '.$descripcionClausula[37].'</strong>: '.$partesDescripcionClausula[40][0].' '.$fechacontratos.'.
		 ...
		 <td align="center">
			...
			<table width="100%" border="0">
			  ...
			  <tr>
				...
				<br/>'.$Modeloordenes->rel_contrato->rel_contratantes->PECO_DESCRIPCION.'
				</td>
				<td align="left">
						'; 
						 if ($datacontratista>0) {
						 ...
						 '; 
						  ...
						  // echo "Entro al sino";
						   ...
						   <br/>'.$Modeloordenes->rel_contrato->Persona->rel_personas_juridicas->PEJU_NOMBRE.'
						   <br/>Contratista
						   '; 
						   }
						 $html .='
	   ...
	   ';
  } elseif(($Formclasescontratos->FCCO_ID)==31){/*SI ES UN CONTRATO DE PRESTACION DE SUMINISTRO*/
      /* CARGANDO EL FORMATO DEL CONTRATO */  
	  $criteria = new CDbCriteria;
	  $criteria->condition = 'FCCO_ID = '.$Formclasescontratos->FCCO_ID;
	  $Formdescripcionclausulas = Formdescripcionclausulas::model()->findAll($criteria);
	  ...
	  ///***** CREANDO ARCHIVO *****///
	   ...
	   <tr>
		 <td align="center"><strong>'.$tipo.' DE SUMINISTRO No. '.$numero.'  DE  '.$anio_contrato.' </strong></td>
	   </tr>
	   <tr>
		 <td align="center">&nbsp;</td>
	   </tr>
