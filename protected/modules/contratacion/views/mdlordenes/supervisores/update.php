    ...
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td width="80" align="center">
         ...
         echo CHtml::link($image, array('supervisores/admin',),$htmlOptions ); 
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('supervisores/update','id'=>$model->SUPE_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
