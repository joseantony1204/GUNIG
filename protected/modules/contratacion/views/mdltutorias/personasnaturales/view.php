...
<table width="50%" border="0" align="left">
  ...
  <tr>
	...
	?></td>
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdltutorias/hdveducacioncontinua/admin','id'=>$model->PENA_ID),$htmlOptions ); 
	?></td>
        </tr>
        <tr>
	...
	?></td>
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdltutorias/personasnaturales/miscontratos','id'=>$model->PENA_ID,),$htmlOptions ); 
	?></td>
          <td align="center">&nbsp;</td>
          <td align="center">
	<?php /*
	...
	*/?>
	<?php /*
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdltutorias/personasnaturales/update','id'=>$model->PENA_ID),$htmlOptions ); 
	*/?>
	<?php 
