...
$this->breadcrumbs=array(
	...
	'Programas Tutorias'=>array('admin'),
	'Actualizar',
);
?>
  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		TUTORIASPROGRAMAS  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltutorias/tutoriasprogramas/update','id'=>$model->TUPR_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
