...
$this->breadcrumbs=array(
	...
	'Valor Horas Tutorias'=>array('admin'),
	'Actualizar',
);
?>
  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		TUTORIASVALORHORA  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltutorias/tutoriasvalorhora/update','id'=>$model->TUVH_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
