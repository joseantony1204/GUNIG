    ...
    <td><table width="100%" border="0" align="center">
      <tr>
        ...
        <fieldset>
         ...
         echo CHtml::link($image, array('mdltutorias/personasnaturales/view','id'=>$Personasnaturales->PENA_ID,),$htmlOptions ); 
?></td>
...
<td width="9%" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltutorias/hdvexpedientedocumentos/admin','id'=>$model->PERS_ID),$htmlOptions ); 
?></td>
...
<td width="9%" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltutorias/hdvexpedientedocumentos/unirpdf','id'=>$model->PERS_ID,),$htmlOptions ); 
?></td>
...
<td width="9%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltutorias/hdvexpedientedocumentos/create','id'=>$model->PERS_ID),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
