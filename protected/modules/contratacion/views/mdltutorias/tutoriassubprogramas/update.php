...
$this->breadcrumbs=array(
	...
	'Sub Programas Tutorias'=>array('admin'),
	'Actualizar',
);
?>
  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		TUTORIASSUBPROGRAMAS  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltutorias/tutoriassubprogramas/update','id'=>$model->TUSP_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
