...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltutorias/sedes/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		...
		array('name'=>'CONTRATOST', 'filter'=>false, 'value'=>'$data->CONTRATOST', 'type'=>'number',
			...
			array(
              ...
              'buttons'=>array(       
               'download' => array(
			    ...
			    'url'=>'Yii::app()->controller->createUrl("mdltutorias/tutoriascontratos/download", array("sede"=>$data[SEDE_ID]))',
				),
				'update'=>array('url'=>'Yii::app()->controller->createUrl("mdltutorias/sedes/update", 
			                    array("id"=>$data[SEDE_ID],))',),
			 
			   'delete'=>array('url'=>'Yii::app()->controller->createUrl("mdltutorias/sedes/delete", 
