...
$this->breadcrumbs=array(
	...
	'Presupuestos Tutorias'=>array('admin'),
	'Actualizar',
);
?>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltutorias/tutoriaspresupuestos/update','id'=>$model->PRES_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_form', array('model'=>$model,'Tutoriaspresupuestos'=>$Tutoriaspresupuestos)); ?></p></td>
  </tr>
</table>
