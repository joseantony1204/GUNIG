...
$this->breadcrumbs=array(
	'Jefesdependencias'=>array('index'),
	'Administrar',
);

/*
$this->menu=array(
	array('label'=>'List Jefesdependencias','url'=>array('index')),
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('jefesdependencias/admin',),$htmlOptions ); 
?>         
		 </td>
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('jefesdependencias/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
    ...
    'filter'=>$model,
	'columns'=>array(
		array('name'=>'PERS_IDENTIFICACION', 'value'=>'$data->rel_personal->nombreCompleto', 'filter'=>Jefesdependencias::getPersonas()),
		...
		array(
              ...
              'template'=>'{delete}',
              'buttons'=>array(       
			   'delete'=> array('url'=>'Yii::app()->controller->createUrl("jefesdependencias/delete", array("id"=>$data[JEDE_ID],"command"=>"delete"))',),
			  ),
			),
	),
)); ?>
