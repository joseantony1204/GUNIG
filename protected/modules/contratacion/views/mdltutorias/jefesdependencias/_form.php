...
<?php 
$criterio = array('order'=>'PERS_NOMBRES ASC');
$data=Personas::model()->findAll($criterio);    
$list = CHtml::listData($data,'PERS_IDENTIFICACION', 'nombreCompleto'); 

echo $form->labelEx($model, 'PERS_IDENTIFICACION');
$this->widget('ext.select2.ESelect2',array(
  'name'=>'PERS_IDENTIFICACION',
  'data'=>$list,
  'value'=>$list->PERS_IDENTIFICACION,
