...
<td width="9%" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltutorias/cuentas/admin','id'=>$model->CONT_ID),$htmlOptions ); 
?></td>
...
<td width="9%" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltutorias/cuentas/create','id'=>$model->CONT_ID),$htmlOptions ); 
?></td>
            </tr>
          </table>
          </fieldset>
		...
		array(
              ...
              'buttons' => array(
                                'ver' => array(
                                               ...
                                               'url' => 'Yii::app()->controller->createUrl("mdltutorias/seguimientocuentas/admin",
