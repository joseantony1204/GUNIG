...
<td width="9%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltutorias/tutorias/create','id'=>$model->TUCO_ID),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'filter'=>$model,
	'columns'=>array(
		array('name'=>'TUTO_INTENSIDAD', 'value'=>'$data->TUTO_INTENSIDAD','htmlOptions'=>array('style'=>'text-align: center','width'=>'95'),),
		...
		array('name'=>'SEDE_ID', 'value'=>'$data->Sede->SEDE_NOMBRE', 'filter'=>Tutorias::getSedes($_REQUEST['id']),'htmlOptions'=>array('width'=>'50')),
		...
		array('name'=>'MODULOS', 'filter' => false, 'value'=>'CHtml::link($data->MODULOS,Yii::app()->createUrl("contratacion/mdltutorias/tutoriasmodulos/detail",
