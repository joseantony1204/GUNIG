...
$this->breadcrumbs=array(
	...
	'Contratos Tutorias'=>array('tutoriascontratos/admin'),
        ...
        <fieldset>
          <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE TUTORIAS</em></span></strong></td>
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('tutorias/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
