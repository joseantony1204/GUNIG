	  ...
	  <tr>
        ...
        <table width="100%" border="0">
	       <tr>
	        <td>
             ...
             <?php echo $form->dropDownList($Personas,'PAIS_ID',$data, 
			                                array(
											      'ajax' => array(
                                                                  'type' => 'POST',
                                                                  'url' => CController::createUrl('mdltutorias/personas/obtdepa'),
	        ...
	        <td>&nbsp;</td>
	        <td>
             <?php $citerio = array('order'=>'DEPA_NOMBRE'); ?>
             <?php echo $form->labelEx($Personas,'DEPA_ID'); ?>
			 <?php $data = CHtml::listData(Departamentos::model()->findAll($citerio),'DEPA_ID','DEPA_NOMBRE') ?>
             <?php echo $form->dropDownList($Personas,'DEPA_ID',$data, 
			                                array(
											      'ajax' => array(
                                                                  'type' => 'POST',
                                                                  'url' => CController::createUrl('mdltutorias/personas/obtmuni'),
           ...
           <tr>
	        <td>
             <?php $citerio = array('order'=>'MUNI_NOMBRE'); ?>
             <?php echo $form->labelEx($Personas,'MUNI_ID'); ?>
			 <?php $data = CHtml::listData(Municipios::model()->findAll($citerio),'MUNI_ID','MUNI_NOMBRE') ?>
             <?php echo $form->dropDownList($Personas,'MUNI_ID',$data, array('class'=>'span3','prompt'=>'Elije...')); ?>
