...
$this->breadcrumbs=array(
	...
	'Hoja de vida'=>array('mdlocasionales/personasnaturales/view/','id'=>$model->PENA_ID),
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlocasionales/personasnaturalesestudios/create','id'=>$model->PENA_ID),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
