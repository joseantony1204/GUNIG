...
$this->breadcrumbs=array(
	...
	'Contratos'=>array('mdlocasionales/contratos/admin'),
	'Actualizar',
);
?>
  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		OCASIONALESCONTRATOS  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlocasionales/ocasionalescontratos/update','id'=>$model->OCCO_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
