...
$this->breadcrumbs=array(
	...
	'Facultades'=>array('mdlocasionales/facultades/admin'),
	'Administrar',
);
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlocasionales/facultades/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
        ...
        array(
              ...
              'buttons'=>array(       
               'download' => array(
			    ...
			    'url'=>'Yii::app()->controller->createUrl("mdlocasionales/ocasionalescontratos/download", array("facultad"=>$data[FACU_ID]))',
				),
				'update'=>array('url'=>'Yii::app()->controller->createUrl("mdlocasionales/facultades/update", 
			                    array("id"=>$data[FACU_ID],))',),
			 
			   'delete'=>array('url'=>'Yii::app()->controller->createUrl("mdlocasionales/facultades/delete", 
