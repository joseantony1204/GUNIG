...
<table width="50%" border="0" align="left">
  ...
  <tr>
    <td height="21"><fieldset>
	 ...
	 echo CHtml::link($image, array('mdlocasionales/hdvexpedientedocumentos/admin','id'=>$model->PERS_ID),$htmlOptions ); 
	?></td>
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlocasionales/personasnaturalesestudios/admin','id'=>$model->PENA_ID),$htmlOptions ); 
	?></td>
          <td width="8%" scope="col">&nbsp;</td>
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlocasionales/hdveducacioncontinua/admin','id'=>$model->PENA_ID),$htmlOptions ); 
	?></td>
        </tr>
        <tr>
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlocasionales/personasexperiencialaboral/admin','id'=>$model->PERS_ID),$htmlOptions ); 
	?></td>
          <td>&nbsp;</td>
          <td align="center"><?php /*
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlocasionales/personasnaturales/miscontratos','id'=>$model->PENA_ID,),$htmlOptions ); 
	*/?>
            <?php
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlocasionales/personasnaturales/update','id'=>$model->PENA_ID),$htmlOptions ); 
	?></td>
          <td align="center">&nbsp;</td>
          <td align="center">
	<?php /*
	...
	*/?>
	<?php 
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlocasionales/personasnaturales/view','id'=>$model->PENA_ID),$htmlOptions ); 
	?></td>
        </tr>
        <tr>
