  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		DOCENTES OCASIONALES  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlocasionales/persnaturalesocasionales/update',
		 'id'=>$Persnaturalesocasionales->PENO_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
