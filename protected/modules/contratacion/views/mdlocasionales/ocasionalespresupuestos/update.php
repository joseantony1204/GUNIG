...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlocasionales/ocasionalespresupuestos/update','id'=>$Ocasionalespresupuestos->OCPR_ID),
		 $htmlOptions ); 
?>         
		          </td>
      </tr>
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_form', array('Presupuestos'=>$Presupuestos,
