...
$this->breadcrumbs=array(
	...
	'Periodos Académicos'=>array('mdlcatedraticos/periodosacademicos/admin'),
	'Administrar',
);
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlcatedraticos/periodosacademicos/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
	...
	'columns'=>array(
		...
		array('name'=>'PEAC_FECHA_FINAL', 'value'=>'$data->PEAC_FECHA_FINAL', 'htmlOptions'=>array('width'=>'150'),),		 
		 array( 
			  ...
			  'value'=> 'CHtml::link(CHtml::image($data->imagenEstado),array("mdlcatedraticos/periodosacademicos/changeState",
