  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td align="left">
        <strong style="border-bottom-style:groove">PROCESO DE ADMINISTRACÓN DE REGISTROS [ 
		DOCENTES CATEDRATICOS  : Nuevo ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlcatedraticos/persnaturalescatedraticos/create',
		                                'id'=>$Persnaturalescatedraticos->PENA_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
