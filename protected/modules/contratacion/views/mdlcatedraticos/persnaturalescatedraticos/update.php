  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		DOCENTES CATEDRATICOS  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlcatedraticos/persnaturalescatedraticos/update',
		                                'id'=>$Persnaturalescatedraticos->PENC_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_formm', array('Persnaturalescatedraticos'=>$Persnaturalescatedraticos,
