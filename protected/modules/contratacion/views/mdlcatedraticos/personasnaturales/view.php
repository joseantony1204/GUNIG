...
<table width="50%" border="0" align="left">
  ...
  <tr>
	...
	?></td>
	 ...
	 $htmlOptions = array('class' => 'thumbnail','rel' => 'tooltip','data-title' => 'Esducacion Continuada');
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlcatedraticos/hdveducacioncontinua/admin','id'=>$model->PENA_ID),$htmlOptions ); 
	?></td>
        </tr>
        <tr>
	...
	*/?>
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlcatedraticos/personasnaturales/update','id'=>$model->PENA_ID),$htmlOptions ); 
	?></td>
          <td align="center">&nbsp;</td>
          <td align="center"><?php 
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('mdlcatedraticos/personasnaturales/view','id'=>$model->PENA_ID),$htmlOptions ); 
	?></td>
        </tr>
        <tr>
