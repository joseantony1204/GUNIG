        ...
        <fieldset>
          <table width="100%" border="0" align="center">
			...
			?>
             ...
             <td width="73%"><strong><span><em>MI HISTORIAL DE CONTRATACION</em></span></strong></td>
...
<td width="7%" align="center">
        <?php
         ...
         $htmlOptions = array('class' => 'thumbnail','rel' => 'tooltip','data-title' => 'Refrescar Pagina');
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltutorias/tutoriascontratos/create','id'=>$model->PERS_ID),$htmlOptions ); 
        ?>
		...
		array('name'=>'ANAC_NOMBRE', 'value'=>'$data->ANAC_NOMBRE',  'htmlOptions'=>array('width'=>'150'),),
              ...
              'buttons' => array(
                                'ver' => array(
                                               ...
                                               'url' => 'Yii::app()->controller->createUrl("mdltutorias/expedientedocumentos/admin",
