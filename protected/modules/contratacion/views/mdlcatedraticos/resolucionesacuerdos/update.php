...
$this->breadcrumbs=array(
	'Resolucionesacuerdos'=>array('index'),
	'Crear',
);
?>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlordenes/resolucionesacuerdos/update','id'=>$model->REAC_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
