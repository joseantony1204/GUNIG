...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlcatedraticos/catedraticoscatedras/update','id'=>$Catedraticoscatedras->CACA_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_form', array('Catedraticoscatedras'=>$Catedraticoscatedras,)); ?></p></td>
  </tr>
</table>
