...
class Sedes extends CActiveRecord
{
	...
	{
	 $criteria=new CDbCriteria;
     $criteria->select='SEDE_ID, SEDE_NOMBRE';
	$criteria->order = 'SEDE_NOMBRE ASC';
	 return  CHtml::listData(Sedes::model()->findAll($criteria),'SEDE_ID','SEDE_NOMBRE'); 
	}
	
	 public function getNombreSedes($SEDE_ID){
		
	  $connection = Yii::app()->db;
		  $sql="SELECT SEDE_NOMBRE FROM TBL_SEDES WHERE SEDE_ID=".$SEDE_ID."";
