...
if(isset($_POST['Graduados']))
        ...
        }elseif(isset($_POST['Titulostrabajosgrados'])){
			$titulostrabajogrados->attributes=$_POST['Titulostrabajosgrados'];

			$cedulaExiste=$titulostrabajogrados->titulogradoExiste($titulostrabajogrados->TITG_NOMBRE);
			if($titulostrabajogrados->TITG_NOMBRE!=null){
			if($cedulaExiste==1){
...
}elseif(isset($_POST['Registrograduados']))
		{ 
