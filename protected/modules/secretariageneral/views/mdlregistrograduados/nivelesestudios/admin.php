...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('nivelesestudios-grid', {
		data: $(this).serialize()
	});
	return false;
});
        ...
        <fieldset>
          <table width="100%" border="0" align="center">
            <tr>
              ...
              <?php 			 
			 $imageUrl = Yii::app()->request->baseUrl . '/images/secretariageneral/nivelesestudios.png';
			  echo $image = CHtml::image($imageUrl); 
			  ?>         
			               
              </td>
             <td width="63%"><strong><span><em>ADMINISTRACION DE NIVELES ESTUDIOS</em></span></strong></td>
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlregistrograduados/nivelesestudios/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
