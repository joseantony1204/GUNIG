...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('titulos-grid', {
		data: $(this).serialize()
	});
	return false;
});
        ...
        <fieldset>
          <table width="100%" border="0" align="center">
            <tr>
              ...
              <?php 			 
			 $imageUrl = Yii::app()->request->baseUrl . '/images/secretariageneral/titulos.png';
			  echo $image = CHtml::image($imageUrl); 
			  ?>         
			               
              </td>
             <td width="63%"><strong><span><em>ADMINISTRACION DE TITULOS</em></span></strong></td>
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlregistrograduados/titulos/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		'TITU_ID',
		'TITU_NOMBRE',
		array('name'=>'PROG_ID', 'value'=>'$data->rel_programas->PROG_NOMBRE', 
