...
$this->breadcrumbs=array(
	...
	'Titulos Trabajos de Grados'=>array('admin'),
	'Administrar',
);
/*
$this->menu=array(
	array('label'=>'List Titulostrabajosgrados','url'=>array('index')),
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('titulostrabajosgrados-grid', {
		data: $(this).serialize()
	});
	return false;
});
        ...
        <fieldset>
          <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE TITULOSTRABAJOSGRADOS</em></span></strong></td>
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlregistrograduados/titulostrabajosgrados/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
