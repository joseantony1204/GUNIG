...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('jornadas-grid', {
		data: $(this).serialize()
	});
	return false;
});
        ...
        <fieldset>
          <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE JORNADAS</em></span></strong></td>
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlregistrograduados/jornadas/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
