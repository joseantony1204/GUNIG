  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		PERFILES USUARIOS  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('roles/usersperfilesusuarios/update','id'=>$Usersperfilesusuarios->USPU_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_form', array('Users'=>$Users,'Usersperfilesusuarios'=>$Usersperfilesusuarios)); ?></p></td>
  </tr>
</table>
