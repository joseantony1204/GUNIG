  ...
  <tr>
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <td>&nbsp;</td>
        <td>
		<?php echo $form->hiddenField($Usersperfilesusuarios,'USPU_FECHAINGRESO',array('value'=>date("Y-m-d").' '.date("h:i:s"))); ?></td>
      </tr>
    </table>
    </fieldset>
	...
	<div class="form-actions">
		<?php $this->widget('bootstrap.widgets.TbButton', array(
			...
			'type'=>'success',
			'size'=>'small',
			'label'=>$Usersperfilesusuarios->isNewRecord ? 'Crear' : 'Actualizar',
		)); ?>
	</div>
