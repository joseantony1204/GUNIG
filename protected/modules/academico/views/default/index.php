<?php
Yii::app()->homeUrl = array('/academico');
    ...
    <fieldset>
      <table width="100%" border="0" align="center">
        <tr>
          ...
          <?php
	      $imageUrl = Yii::app()->request->baseUrl . '/images/mod_academico.png';
	      echo $image = CHtml::image($imageUrl);
	      ?>
          </td>
          <td width="750" align="left"><h3><?php echo "GESTIÓN MODULO DE ACADÉMICO"; ?></h3></td>
        </tr>
      </table>
    </fieldset></td>
  </tr>
