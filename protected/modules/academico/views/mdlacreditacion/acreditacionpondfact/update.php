...
$this->breadcrumbs=array(
	'Acreditacionpondfact'=>array('index'),
	'Crear',
);
?>
  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		ACREDITACIONPONDFACT  : Editar ] </strong></td>
        <td width="80" align="center">
         ...
         echo CHtml::link($image, array('acreditacionpondfact/admin',),$htmlOptions ); 
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('acreditacionpondfact/update','id'=>$model->ACPO_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
