    ...
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td width="80" align="center">
         ...
         echo CHtml::link($image, array('acreditacion/admin',),$htmlOptions ); 
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('acreditacion/update','id'=>$model->ACRE_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
