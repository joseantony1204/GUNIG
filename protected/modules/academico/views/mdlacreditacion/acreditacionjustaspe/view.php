  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td width="498" align="left"><strong style="border-bottom-style:groove">VISUALIZACIÒN DE REGISTROS [ ACREDITACIONJUSTASPE : Detalles ] </strong></td>
...
?>         
        ...
        <td width="80" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('acreditacionjustaspe/view','id'=>$model->ACJA_ID),$htmlOptions ); 
?>         
		 </td>
        <td width="80" align="center"><?php
