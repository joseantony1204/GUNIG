...
$this->breadcrumbs=array(
	'Acreditacionbitacoras'=>array('index'),
	'Crear',
);
?>
  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		ACREDITACIONBITACORAS  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('acreditacionbitacoras/update','id'=>$model_bitaco->ACBI_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_form', array('model_bitaco'=>$model_bitaco)); ?></p></td>
  </tr>
</table>
