...
/*
$this->menu=array(
	array('label'=>'List acreditacionbitacoras','url'=>array('index')),
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('acreditacionbitacoras-grid', {
		data: $(this).serialize()
	});
	return false;
});
        ...
        <fieldset>
          <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE BITACORAS</em></span></strong></td>
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('acreditacionbitacoras/admin',),$htmlOptions ); 
?>         
		 </td>
