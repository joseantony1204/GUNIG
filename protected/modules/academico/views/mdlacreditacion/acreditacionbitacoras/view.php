  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td width="498" align="left"><strong style="border-bottom-style:groove">VISUALIZACIÒN DE REGISTROS [ BITACORAS : Detalles ] </strong></td>
...
?>         
        ...
        <td width="80" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('acreditacionbitacoras/view','id'=>$model->ACBI_ID),$htmlOptions ); 
?>         
		 </td>
        <td width="80" align="center"><?php
         ...
         $htmlOptions = array('class' => 'thumbnail','rel' => 'tooltip','data-title' => 'Creaciòn de registros');
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('acreditacionbitacoras/update','id'=>$model->ACBI_ID),$htmlOptions ); 
?>         
		 </td>
        ...
        <td width="80" align="center"><?php $imageUrl = Yii::app()->request->baseUrl . '/images/academico/acreditacion/factores.png';
		 ...
		 $image = CHtml::image($imageUrl);
		 echo CHtml::link($image, array('mdlacreditacion/acreditacionfactores/create','BITACORA'=>$model->ACBI_ID),$htmlOptions ); 														 														
		 ?>
	  </td>
