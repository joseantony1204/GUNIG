...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('acreditacionprogramas-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('acreditacionprogramas/admin',),$htmlOptions ); 
?>         
		 </td>
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('acreditacionprogramas/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
