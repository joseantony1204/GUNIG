      ...
      <tr>
        <td width="60" align="left"><?php 			 
			 $imageUrl = Yii::app()->request->baseUrl . '/images/academico/categruposinvestigacion.png';
			  ...
			  ?> </td>
        <td width="498" align="left"><strong style="border-bottom-style:groove">VISUALIZACIÒN DE REGISTROS [ CATEGORÍA DE GRUPOS DE INVESTIGACIÓN : Detalles ] </strong></td>
...
?>         
        ...
        <td width="80" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlcargasacademicas/categruposinvestigacion/view','id'=>$model->CAGI_ID),$htmlOptions ); 
?>         
		 </td>
        <td width="80" align="center"><?php
