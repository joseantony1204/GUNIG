  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		TIPOSESTUDIOS  : Editar ] </strong></td>
        <td width="80" align="center">
         ...
         echo CHtml::link($image, array('mdlcargasacademicas/tiposestudios/admin',),$htmlOptions ); 
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlcargasacademicas/tiposestudios/update','id'=>$model->TIES_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
