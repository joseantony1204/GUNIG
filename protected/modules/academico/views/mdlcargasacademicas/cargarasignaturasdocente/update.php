  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		AGREGAR ASIGNATURAS A DOCENTE  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlcargasacademicas/cargarasignaturasdocente/update','id'=>$model->CAAD_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
