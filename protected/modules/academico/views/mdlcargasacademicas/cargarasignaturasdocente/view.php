      ...
      <tr>
        <td width="60" align="left"><?php 			 
			 $imageUrl = Yii::app()->request->baseUrl . '/images/academico/cargaacademica.png';
			  ...
			  ?> </td>
        <td width="498" align="left"><strong style="border-bottom-style:groove">VISUALIZACIÒN DE REGISTROS [ CARGARASIGNATURASDOCENTE : Detalles ] </strong></td>
...
?>         
        ...
        <td width="80" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlcargasacademicas/cargarasignaturasdocente/view','id'=>$model->CAAD_ID),$htmlOptions ); 
?>         
		 </td>
        <td width="80" align="center"><?php
