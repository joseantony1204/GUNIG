  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td width="498" align="left"><strong style="border-bottom-style:groove">VISUALIZACIÒN DE REGISTROS [ ASIGNAR DOCENTE A UN PERIODO ACADÉMICO : Detalles ] </strong></td>
...
?>         
        ...
        <td width="80" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlcargasacademicas/precargasacademicas/view','id'=>$model->PRCA_ID),$htmlOptions ); 
?>         
		 </td>
        <td width="80" align="center"><?php
         ...
         $htmlOptions = array('class' => 'thumbnail','rel' => 'tooltip','data-title' => 'Creaciòn de registros');
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlcargasacademicas/precargasacademicas/update','id'=>$model->PRCA_ID),$htmlOptions ); 
?>         
		 </td>
      </tr>
    </table></td>
