  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		PROGRAMAS  ACADEMICOS: Editar ] </strong></td>
        <td width="80" align="center">
         ...
         echo CHtml::link($image, array('mdlunidadesacademica/programas/admin',),$htmlOptions ); 
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdelunidadesacademicas/programas/update','id'=>$model->PROG_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
