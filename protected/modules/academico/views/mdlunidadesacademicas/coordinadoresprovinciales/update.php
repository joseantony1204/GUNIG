  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		COORDINADORESPROVINCIALES  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlunidadesacademicas/coordinadoresprovinciales/update','id'=>$model->COPRO_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
