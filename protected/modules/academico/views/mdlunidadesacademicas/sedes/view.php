...
?>         
        ...
        <td width="80" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlunidadesacademicas/sedes/view','id'=>$model->SEDE_ID),$htmlOptions ); 
?>         
		 </td>
        <td width="80" align="center"><?php
         ...
         $htmlOptions = array('class' => 'thumbnail','rel' => 'tooltip','data-title' => 'Creaciòn de registros');
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlunidadesacademicas/sedes/update','id'=>$model->SEDE_ID),$htmlOptions ); 
?>         
		 </td>
      </tr>
    </table></td>
