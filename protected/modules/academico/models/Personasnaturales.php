...
class Personasnaturales extends CActiveRecord
{
	...
	public function getNombreCompletoId()
	{
		$sql='SELECT pn.PENA_ID, CONCAT(p.PERS_IDENTIFICACION," ",pn.PENA_NOMBRES," ",pn.PENA_APELLIDOS) AS id
		FROM TBL_PERSONASNATURALES pn 
		INNER JOIN TBL_PERSONAS p ON pn.PERS_ID = p.PERS_ID
		ORDER BY pn.PENA_NOMBRES ASC';
