...
/**
 * This is the model class for table "tbl_acreditacionpondcara".
 *
 * The followings are the available columns in table 'tbl_acreditacionpondcara':
 ...
 */
class acreditacionpondcara extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return acreditacionpondcara the static model class
	 */
	...
	{
		return 'tbl_acreditacionpondcara';
	}
