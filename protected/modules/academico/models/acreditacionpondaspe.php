...
/**
 * This is the model class for table "tbl_acreditacionpondaspe".
 *
 * The followings are the available columns in table 'tbl_acreditacionpondaspe':
 ...
 */
class acreditacionpondaspe extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return acreditacionpondaspe the static model class
	 */
	...
	{
		return 'tbl_acreditacionpondaspe';
	}
	...
	public function rules()
	{
		...
		return array(
			array('ACAS_ID, USUA_ID', 'numerical', 'integerOnly'=>true),
			array('ACPO_GRUPO1, ACPO_GRUPO2, ACPO_GRUPO3, ACPO_GRUPO4, ACPO_GRUPO5', 'numerical'),
			array('ACPO_FECHA', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ACPO_ID, ACPO_GRUPO1, ACPO_GRUPO2, ACPO_GRUPO3, ACPO_GRUPO4, ACPO_GRUPO5, ACAS_ID, ACPO_FECHA, USUA_ID', 'safe', 'on'=>'search'),
		);
	}
