...
class Cargasacademicas extends CActiveRecord
{
	 ...
	 */
	public $NOMBRE_DOCENTE, $HEXTENSION, $HINVESTIGACION, $HDDIRECTA, $TH, $ESTADO, $TICD_ID, $HDDIRECTASEMESTRE, $HDDIRECTAMES;
	...
	public function rules()
	{
		...
		return array(
			array('PENA_ID, TICD_ID', 'required'),
			array('PENA_ID, TICD_ID', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('PRCA_ID, PENA_ID, TICD_ID', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'HINVESTIGACION'=>'INVESTIGACIÓN',
			'HDDIRECTA'=>'DOCENCIA DIRECTA',
			'TH'=>'TOTAL HORAS',
			'ESTADO'=>'ESTADO',
		);
	}
	...
	public function listadoDocentesP(){
...
INNER JOIN TBL_PERSONASNATURALES pn ON pn.PENA_ID=t.PENA_ID
		...
		WHERE t.TICD_ID=4 ORDER BY fac.FACU_NOMBRE ASC';	
	 ...
	 return	$data;
				...
				public function listadoDocentesO(){
...
INNER JOIN TBL_PERSONASNATURALES pn ON pn.PENA_ID=t.PENA_ID
		...
		INNER JOIN TBL_TIPOCONTRATACIONDOCENTES ticd ON ticd.TICD_ID=t.TICD_ID
		INNER JOIN TBL_FACULTADES fac ON fac.FACU_ID=t.FACU_ID 
		WHERE t.TICD_ID=5 ORDER BY fac.FACU_NOMBRE ASC';	
	 ...
	 return	$data;
		...
		public function listadoDocentesC(){
...
INNER JOIN TBL_PERSONASNATURALES pn ON pn.PENA_ID=t.PENA_ID
		...
		INNER JOIN TBL_TIPOCONTRATACIONDOCENTES ticd ON ticd.TICD_ID=t.TICD_ID
		INNER JOIN TBL_FACULTADES fac ON fac.FACU_ID=t.FACU_ID 
		WHERE t.TICD_ID=6 ORDER BY fac.FACU_NOMBRE ASC';	
