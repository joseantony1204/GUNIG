...
$this->breadcrumbs=array(
	...
	'Seguimiento Cuenta'=>array('mdltcuentas/seguimientocuentas/admin','id'=>$Seguimientocuentas->CUEN_ID),
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltcuentas/devolucionescuentas/admin','id'=>$model->SECU_ID),$htmlOptions ); 
?>         
		 </td>
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltcuentas/devolucionescuentas/create','id'=>$model->SECU_ID),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		...
		array(
              ...
              'buttons'=>array(       
			   'delete' => array(
			    'url'=>'Yii::app()->controller->createUrl("mdltcuentas/devolucionescuentas/delete", 
