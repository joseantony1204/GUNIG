        ...
        <fieldset>
          <table width="100%" border="0" align="center">
            <tr>
              ...
              <td width="49%"><strong><span><em>ADMINISTRACION DE CUENTAS - </em></span></strong><span><em><strong>NO TRAMITADAS</strong></em></span></td>
...
?></td>
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdltcuentas/cuentas/reporteCuentasN',),$htmlOptions ); 
?></td>
              <td width="9%" align="center"><?php
		 $imageUrl = Yii::app()->request->baseUrl . '/images/add.png';
         $htmlOptions = array('class' => 'thumbnail','rel' => 'tooltip','data-title' => 'Agregar una Cuenta');
         $image = CHtml::image($imageUrl);
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	'id'=>'cuentas-grid',
	'dataProvider'=>$Cuentas->buscarCuentasNoTramitadas(),
