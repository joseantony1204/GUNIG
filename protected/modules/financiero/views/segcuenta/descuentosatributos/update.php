...
$this->breadcrumbs=array(
	'Descuentosatributos'=>array('index'),
	'Crear',
);
?>
  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		DESCUENTOSATRIBUTOS  : Editar ] </strong></td>
...
?>        
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('segcuenta/descuentosatributos/update','id'=>$model->DEAT_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
