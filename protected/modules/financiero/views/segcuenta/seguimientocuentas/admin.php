...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('segcuenta/seguimientocuentas/create','id'=>$model->CUEN_ID),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
	...
	'columns'=>array(
		...
		array(
              ...
              'buttons'=>array(       
			   ...
			   'update' => array(
			    'url'=>'Yii::app()->controller->createUrl("segcuenta/seguimientocuentas/update", array("id"=>$data[SECU_ID],))',
				),
			   'delete' => array(
			    'url'=>'Yii::app()->controller->createUrl("segcuenta/seguimientocuentas/delete", 
