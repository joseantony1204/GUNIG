    ...
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td width="80" align="center"><?php
         ...
         echo CHtml::link($image, array('resoluciones/admin',),$htmlOptions ); 
?>         
		 </td>
        <td width="80" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('resoluciones/view','id'=>$model->RESO_ID),$htmlOptions ); 
?>         
		 </td>
        <td width="80" align="center"><?php
         ...
         $htmlOptions = array('class' => 'thumbnail','rel' => 'tooltip','data-title' => 'Creaciòn de registros');
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('resoluciones/update','id'=>$model->RESO_ID),$htmlOptions ); 
?>         
		 </td>
      </tr>
    </table></td>
