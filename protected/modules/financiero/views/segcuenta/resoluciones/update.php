  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td align="left">
        <strong style="border-bottom-style:groove">PROCESO DE ACTUALIZACIÒN DE REGISTROS [ RESOLUCIONES  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('segcuenta/resoluciones/update','id'=>$Resoluciones->RESO_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
