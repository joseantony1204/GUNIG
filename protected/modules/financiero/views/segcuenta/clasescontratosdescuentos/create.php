...
$this->breadcrumbs=array(
	...
	'Clases Contratos Descuentos'=>array('clasescontratosdescuentos/detail','id'=>$model->CLCO_ID),
	'Modulos de Clases Contratos Descuentos',
);
?>
  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td align="left">
        <strong style="border-bottom-style:groove">PROCESO DE CREACIÒN DE REGISTROS [AGREGAR DESCUENTO A <?php echo $model->cLCO->CLCO_NOMBRE; ?>] </strong></td>
