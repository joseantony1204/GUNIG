    ...
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td width="80" align="center">
         ...
         echo CHtml::link($image, array('contratos/admin',),$htmlOptions ); 
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('contratos/update','id'=>$model->CONT_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
