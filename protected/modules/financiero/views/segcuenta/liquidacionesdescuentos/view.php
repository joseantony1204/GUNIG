  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td width="498" align="left"><strong style="border-bottom-style:groove">VISUALIZACIÒN DE REGISTROS [ LIQUIDACIONESDESCUENTOS : Detalles ] </strong></td>
...
?>         
        ...
        <td width="80" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('liquidacionesdescuentos/view','id'=>$model->LIDE_ID),$htmlOptions ); 
?>         
		 </td>
        <td width="80" align="center"><?php
