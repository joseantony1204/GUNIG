        ...
        <fieldset>
          <table width="100%" border="0" align="center">
            <tr>
              ...
              <td width="52%"><strong><span><em>ADMINISTRACION DE CUENTAS - </em></span></strong><span><em><strong>NO TRAMITADAS</strong></em></span></td>
...
?></td>
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('segcuenta/cuentas/reporteCuentasN',),$htmlOptions ); 
?></td>
            </tr>
          </table>
        </fieldset>
