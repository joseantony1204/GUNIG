    ...
    <td><table width="100%" border="0" align="center">
      <tr>
        ...
        <fieldset>
          <table width="100%" border="0" align="center">
            <tr>
              <td width="8%" align="center"><img src="../images/setting.png" width="60" height="70" /></td>
             <td width="56%"><strong><span><em>ADMINISTRACION DE EXPEDIENTE DOCUMENTOS
...
<td width="9%" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('segcuenta/expedientedocumentos/unirpdf','id'=>$model->CONT_ID),$htmlOptions ); 
?></td>
