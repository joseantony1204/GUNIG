...
class Resolucionesliquidaciones extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('RELI_VALOR, CLRE_ID, ANAC_ID, RESO_ID', 'required'),
			array('RELI_VALOR, DEAT_ID, DEAT_IDD, CLRE_ID, ANAC_ID, RESO_ID', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('RELI_ID, RELI_VALOR, RELI_EJECUTADO, RELI_UTILIDAD, RELI_AMOTIZACION, RELI_IVA, DEAT_ID, DEAT_IDD, CLRE_ID, ANAC_ID, RESO_ID', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'RELI_ID' => 'Reli',
			'RELI_VALOR' => 'Valor Rosolucion',
			'RELI_EJECUTADO' => 'Valor Ejecutado',
            'RELI_UTILIDAD' => 'Utilidad',
            'RELI_AMOTIZACION' => 'Amotizacion',
            'RELI_IVA' => 'Iva',
			'DEAT_ID' => 'Deat',
			'DEAT_IDD' => 'Deat Idd',
			'CLRE_ID' => 'Clase de Resolucion',
			'ANAC_ID' => 'Año',
			'RESO_ID' => 'Reso',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('RESO_ID',$this->RELI_ID);
