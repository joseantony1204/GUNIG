...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	$criteria->select = 't.ESTU_ID, CONCAT(te.TIES_NOMBRE,"'." -- ".'",t.ESTU_NOMBRE) AS ESTU_NOMBRE';
	$criteria->order = 'ESTU_NOMBRE ASC';
	$criteria->join ='INNER JOIN TBL_TIPOSESTUDIOS  te ON te.TIES_ID = t.TIES_ID';
	
	$data=Estudios::model()->findAll($criteria);    
