        ...
        <table width="100%" border="0">
	      <tr>
	        <td>
             ...
             <?php echo $form->dropDownList($Personas,'TIID_ID',$data, array('class'=>'span3','prompt'=>'Elige...')); ?>
           ...
           <tr>
	        <td>
             ...
             <?php echo $form->dropDownList($Personasnaturales,'SEXO_ID',$data, array('class'=>'span3','prompt'=>'elige......')); ?>
	        ...
	        <td>
             ...
             <?php echo $form->dropDownList($Personasnaturales,'ESCI_ID',$data, array('class'=>'span3','prompt'=>'elige......')); ?>
        ...
        <table width="100%" border="0">
	        ...
	        <td>
             ...
             <?php echo $form->dropDownList($Personasnaturales,'PAIS_ID',$data, 
			                                array(
											      'ajax' => array(
                                                                  'type' => 'POST',
                                                                  'url' => CController::createUrl('userhdv/personasnaturales/obtdepa'),
	        ...
	        <td>
             ...
             <?php echo $form->dropDownList($Personasnaturales,'DEPA_ID',$lista_uno, 
			                                array(
											      'ajax' => array(
                                                                  'type' => 'POST',
                                                                  'url' => CController::createUrl('userhdv/personasnaturales/obtmuni'),
           ...
           <tr>
	        <td>
			 ...
			 ?>
   <?php echo $form->dropDownList($Personasnaturales,'MUNI_ID',$lista_uno, array('class'=>'span3','prompt'=>'Elige un departamento...')); ?>
        ...
        <table width="100%" border="0">
	        ...
	        <td>
             ...
             <?php echo $form->dropDownList($Personas,'PAIS_ID',$data, 
			                                array(
											      'ajax' => array(
                                                                  'type' => 'POST',
                                                                  'url' => CController::createUrl('userhdv/personas/obtdepa'),
			...
			<?php $criterio = array('order'=>'DEPA_NOMBRE'); ?>
             ...
             <?php echo $form->dropDownList($Personas,'DEPA_ID',$lista_one, 
			                                array(
											      'ajax' => array(
                                                                  'type' => 'POST',
                                                                  'url' => CController::createUrl('userhdv/personas/obtmuni'),
           ...
           <tr>
	        <td>
			 ...
			 ?>
   <?php echo $form->dropDownList($Personas,'MUNI_ID',$lista_one, array('class'=>'span3','prompt'=>'Elige un departamento...')); ?>
