...
<table width="50%" border="0" align="left">
  ...
  <tr>
    <td height="21"><fieldset>
	 ...
	 echo CHtml::link($image, array('userhdv/hdvexpedientedocumentos/admin','id'=>$model->PERS_ID),$htmlOptions ); 
	?></td>
	...
	*/?>
	 ...
	 $htmlOptions = array('class' => 'thumbnail','rel' => 'tooltip','data-title' => 'Educacion Formal');
	 $image = CHtml::image($imageUrl);
	...
	?></td>
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('userhdv/hdveducacioncontinua/admin','id'=>$model->PENA_ID),$htmlOptions ); 
	?></td>
        </tr>
        <tr>
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('userhdv/personasexperiencialaboral/admin','id'=>$model->PERS_ID),$htmlOptions ); 
	?></td>
          <td>&nbsp;</td>
          <td align="center"><?php
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('view','id'=>$model->PENA_ID),$htmlOptions ); 
	?></td>
          <td align="center">&nbsp;</td>
          <td align="center"><?php
	 ...
	 $image = CHtml::image($imageUrl);
	 echo CHtml::link($image, array('userhdv/personasnaturales/update','id'=>$model->PENA_ID),$htmlOptions ); 
	?></td>
        </tr>
        <tr>
