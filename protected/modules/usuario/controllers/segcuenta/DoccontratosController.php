...
class DoccontratosController extends Controller
{
	/**
	...
	public function actionCreate($id)
	{
		...
		$basePath = 'GESTIONDOC/PERSONAS/'.$idPersona.'/CONTRATACION/'.$anioContrato.'/'.$tipoContrato.'/'.$claseContrato.'/'.$numOrden.'/';	        $path = Yii::app()->basePath.'/../uploads/'.$basePath;	
	...
	public function actionAdmin($id)
	{
		...
		if(isset($_GET['Expedientedocumentos'])){
			...
			Yii::app()->user->setState('ExpedientedocumentosSearchParams', $_GET['Expedientedocumentos']);
		}
        $model->CONT_ID = $verificar->CONT_ID;
