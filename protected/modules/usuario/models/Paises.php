 ...
 *
 * The followings are the available columns in table 'TBL_PAISES':
...
class Paises extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('PAIS_NOMBRE, PAIS_DESCRIPCION', 'required'),
			array('PAIS_NOMBRE', 'length', 'max'=>45),
			array('PAIS_DESCRIPCION', 'length', 'max'=>10),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('PAIS_ID, PAIS_NOMBRE, PAIS_DESCRIPCION', 'safe', 'on'=>'search'),
		);
	}
