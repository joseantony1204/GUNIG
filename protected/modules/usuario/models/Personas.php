...
class Personas extends CActiveRecord
{
	 ...
	 */
	public $CONT_ID, $CONT_NUMORDEN, $OPCO_ID, $OPCO_MESES, $OPCO_DIAS, $DEPE_NOMBRE, $OPCO_VALOR_MENSUAL, 
	$ANAC_NOMBRE, $CONT_FECHAINICIO, $CONT_FECHAFINAL, $NOMBRE, $DOCUMENTOS;
  ...
  public function obtenerMisContratos()
	{	
        ...
        $criteria->select = '
		t.PERS_ID, c.CONT_ID, c.CONT_NUMORDEN, c.CONT_FECHAINICIO, c.CONT_FECHAFINAL, oc.OPCO_ID, oc.OPCO_MESES, 
		oc.OPCO_DIAS, d.DEPE_NOMBRE, oc.OPCO_VALOR_MENSUAL, aa.ANAC_NOMBRE, c.CONT_ID AS DOCUMENTOS';
