...
<td width="7%" align="center">
         ...
         echo CHtml::link($image, array('mdlconfig/personasnaturales/view','id'=>$Personasnaturales->PENA_ID),$htmlOptions ); 
?>         
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlconfig/personasexperiencialaboral/create','id'=>$model->PERS_ID),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
