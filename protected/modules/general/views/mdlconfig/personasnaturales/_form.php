	        ...
	        <td>
             ...
             <?php echo $form->dropDownList($Personasnaturales,'PAIS_ID',$data, 
			                                array(
											      'ajax' => array(
                                                                  'type' => 'POST',
                                                                  'url' => CController::createUrl('mdlconfig/personasnaturales/obtdepa'),
	        ...
	        <td>
             ...
             <?php echo $form->dropDownList($Personasnaturales,'DEPA_ID',$lista_uno, 
			                                array(
											      'ajax' => array(
                                                                  'type' => 'POST',
                                                                  'url' => CController::createUrl('mdlconfig/personasnaturales/obtmuni'),
	        ...
	        <td>
             ...
             <?php echo $form->dropDownList($Personas,'PAIS_ID',$data, 
			                                array(
											      'ajax' => array(
                                                                  'type' => 'POST',
                                                                  'url' => CController::createUrl('mdlconfig/personas/obtdepa'),
			...
			<?php $criterio = array('order'=>'DEPA_NOMBRE'); ?>
             ...
             <?php echo $form->dropDownList($Personas,'DEPA_ID',$lista_one, 
			                                array(
											      'ajax' => array(
                                                                  'type' => 'POST',
                                                                  'url' => CController::createUrl('mdlconfig/personas/obtmuni'),
