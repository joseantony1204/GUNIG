    ...
    <td><table width="100%" border="0" align="center">
      <tr>
        ...
        <fieldset>
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlconfig/personasnaturales/view','id'=>$model->PENA_ID),$htmlOptions ); 
?></td>
...
<td width="7%" align="center">
        <?php
         ...
         $htmlOptions = array('class' => 'thumbnail','rel' => 'tooltip','data-title' => 'Refrescar Pagina');
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlconfig/opscontratos/create','id'=>$model->PERS_ID),$htmlOptions ); 
        ?>
</td>
            </tr>
          </table>
             ...
             array(
              ...
              'buttons' => array(
                                'ver' => array(
                                               ...
                                               'url' => 'Yii::app()->controller->createUrl("mdlops/expedientedocumentos/admin",
