...
$this->breadcrumbs=array(
	...
	'Mis Contratos'=>array('mdlops/personasnaturales/miscontratos','id'=>$Personasnaturales->PENA_ID),
...
<td width="9%" align="center">
         ...
         echo CHtml::link($image, array('mdlops/personasnaturales/miscontratos','id'=>$Personasnaturales->PENA_ID),$htmlOptions ); 
        ?>         
...
<td width="9%" align="center">
  <?php         
       ...
       $image = CHtml::image($imageUrl);
       echo CHtml::link($image, array('mdlops/expedientedocumentos/admin','id'=>$model->CONT_ID),$htmlOptions ); 
  ?>
</td>
...
<td width="9%" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlops/expedientedocumentos/unirpdf','id'=>$model->CONT_ID),$htmlOptions ); 
?></td>
...
<td width="9%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlops/expedientedocumentos/create','id'=>$model->CONT_ID),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
