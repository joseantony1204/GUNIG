...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlconfig/periodosacademicos/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
	...
	'columns'=>array(
		...
		array('name'=>'PEAC_FECHA_FINAL', 'value'=>'$data->PEAC_FECHA_FINAL', 'htmlOptions'=>array('width'=>'150'),),		 
		 array( 
			  ...
			  'value'=> 'CHtml::link(CHtml::image($data->imagenEstado),array("mdlconfig/periodosacademicos/changeState",
