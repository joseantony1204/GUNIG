        ...
        <fieldset>
          <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE AÑOS ACADEMICOS</em></span></strong></td>
...
<td width="7%" align="center">
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('mdlconfig/aniosacademicos/create',),$htmlOptions ); 
?>         
		 </td>
            </tr>
          </table>
	...
	'columns'=>array(
		...
		array('name'=>'ANAC_FECHA_FINAL', 'value'=>'$data->ANAC_FECHA_FINAL', 'htmlOptions'=>array('width'=>'150'),),		 
		 array( 
			  ...
			  'value'=> 'CHtml::link(CHtml::image($data->imagenEstado),array("mdlconfig/aniosacademicos/changeState",
